...
class SalesByState extends React.Component {
    ...
    /*
        ...
        and my e-mail address. You can improve here by caching the response as well!

        Personally, I've used this information to overlay fire spots on the Amazon rainforest from an API maintained by NASA
        in a forestry-related mashup for a client in the forestry industry.
    */
            ...
            .then(APIdata => {
                ...
                for (let k = 0; k < APIdata.records.length; k++) {
                    ...
                    if (k == 6 || k == 17 || k == 19 || k == 20 || k == 26 || k == 41) {
                        coordinateList = APIdata.records[k].fields.st_asgeojson.coordinates[0][0]; // The API is bugged(?) as of Feb 9th 2022 and some states return a nested list. Fixing that!
                    }
    ...
    componentDidMount = async () => {
        ...
        this.props.app.createCube(this.hypercube, (reply, app) => {
            ...
            // If you have decent apps with concise information, this integration can be seamless, but since this example app is limited, let's create some data!
